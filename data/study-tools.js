export const STUDY_TOOLS = [
	{
		...
		science:
			'六爻以三钱法连摇六次形成本卦与变卦，适合用于卦象结构学习与民俗文化阅读。',
	...
	},
	{
		...
		science:
			'梅花易数是传统易学推演方法，以简易起式为核心，侧重象数逻辑研习，是民俗易学入门常用体系，多用于文化学习与逻辑推演练习。',
	...
	},
	{
		...
		science:
			'四柱八字又称生辰八字，以干支历法为基础，记录出生时间的干支组合，本工具仅提供排盘展示，用于传统历法文化学习与资料记录。',
	...
	},
	{
		...
		science:
			'干支历法是中国传统纪年体系，由十天干、十二地支组合而成，广泛用于民俗文化与节气记录，是传统时间文化的重要载体。',
	...
	},
	{
		...
		science:
			'生肖文化是中国传统民俗符号，以十二地支对应生肖，本内容仅为民俗文化趣味研习，无运势预测，仅供传统文化爱好者参考。',
	...
	},
	{
		...
		science:
			'姓名民俗解析基于汉字文化与传统起名习俗，仅做字义、笔画的文化解读，为趣味民俗学习内容，不涉及任何评判与建议。',
		usage: '作用：用于学习姓名字形字义与笔画结构，积累汉字文化阅读素材。',
	},
]

export function getStudyToolById(id) {
